        ...
        <th scope="row" style="text-align: left;">
            <div>
                <div style="float: left;">
                    &nbsp;&nbsp; <g:link controller="user" action="userPublicProfile" params="[userId:it.creator.id]">
                    <g:if test="${it.creator.photo}">
                ...
                <=>${it.creator.firstName} ${it.creator.lastName} &nbsp; ${it.lastUpdated}  <span style="float: right"> <g:link controller="topic" action="topicShow" params='[tid:"${it.topic.id}"]'>${it.topic.name}</g:link></span><br />
