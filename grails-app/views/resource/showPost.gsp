            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" style="font-size: 18px;font-weight: bolder;"><g:link
                                        controller="user"
                                        action="userPublicProfile"
                                        params="[userId: post.creator.id]">${post.creator}</g:link></div>

                                <div class="col-md-6" style="text-align: right"><g:link controller="topic"
                                                                                        action="topicShow"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div>&nbsp;&nbsp;<span class="glyphicon glyphicon-user" aria-hidden="true"
                                            ...
                                            id="userCount">${ratedUserCount}</span>
                                    </div>
                    ...
                    <div class="row" style="margin-top: 1px;">
                        <div class="col-md-5"><div class="col-md-12" ><g:img
                                dir="/linksharing/assets" file="fb.jpeg" alt="fb" width="30"/><g:img
                                dir="/linksharing/assets"
                        ...
                        <div class="col-md-4">
                            <g:if test="${showToEditAndDelete}">
                                <input type="button" class="btn btn-primary" id="editPost" value="edit"/>


                                <a id="deleteResource"  class="btn btn-primary"
                                   href="${createLink(controller: "resource", action: "deleteResource", params: [rid: post.id])}">Delete</a>
                            </g:if>
                        </div>
