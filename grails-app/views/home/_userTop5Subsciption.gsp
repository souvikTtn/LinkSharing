...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-6">Subcriptions</div>

            <div class="col-md-6"><g:link controller="subscription" action="userSubscription"
                                          params="[uid: user.id]">view All</g:link></div>

        </div>
    </div>

    <ul class="list-group">
        <g:each in="${subscriptionsTop5Topic}" var="topic">
...
%{--<div class="col-md-6">--}%
%{--<g:link controller="subscription" action="userSubscription"--}%
%{--params="[uid: user.id]">view All</g:link>--}%
%{--</div>--}%
%{--</div>--}%
