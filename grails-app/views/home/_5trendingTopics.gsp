...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-12">Trending Topics</div>

        </div>
    </div>

    <ul class="list-group">
        <g:each in="${tredingTopics}" var="topic">
        ...
        %{--<div class="col-md-12">--}%
            ...
            %{--<div class="row">--}%
                ...
                %{--<div class="col-md-12" >--}%
                    ...
                    %{--<div class="row" >--}%
                        %{--<div class="rowBlock"  style="margin-top: 2px;margin-bottom: 2px; ; border: outset;">--}%
                            ...
                            %{--<div class="row" >--}%
                                ...
                                %{--<div class="col-md-9" >--}%
                                    ...
                                    %{--<div class="row">--}%
                                        ...
                                        %{--</div>--}%
                                        %{--<div class="topic_editDiv" hidden="hidden">--}%
                                            %{--<g:form controll                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "topic" action="editTopic">--}%
                                                %{--<input type="text" name="topicName" value="${topic.name}"/> <g:hiddenField name="tid" value="${topic.id}"/> &nbsp;<input class="btn btn-info" type="submit" value="save"/><input class="cancelEditTopic" type="button" value="cancel"/>--}%
                                            %{--</g:form>--}%
                            ...
                            %{--<div class="row">--}%
                                ...
                                %{--<div class="col-md-2"><a href="${createLink(controller: 'home',action: 'invitation',params: [topicId:topic.id])}" ><span class="glyphicon glyphicon-envelope" aria-hidden="true" style="font-size: 25px"></span></a></div>--}%
                                ...
                                %{--<div class="col-md-2"><a href="" onclick="return false"  class="editTopic" ><span class="glyphicon glyphicon-edit" aria-hidden="true" style="font-size: 25px"></span></a></div>--}%
                                %{--<div class="col-md-2"><a href="${createLink(controller: "topic",action: "deleteTopic",params:[tid:topic.id])}" class="deleteTopic"  onclick="return false" role="button"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="font-size: 25px"></span></a></div>--}%
                                %{--<% } %>--}%
                            %{--</div>--}%
